...
///
/// It can be used in conjunction with `@mathrunet/masamune_cloudflare_tidb` to obtain, read, and write temporary tokens.
///
/// TiDBを利用できるようにしたモデルアダプター。
///
/// `@mathrunet/masamune_cloudflare_tidb`と併用して、一時トークンの取得や読み書きを行うことが可能です。
