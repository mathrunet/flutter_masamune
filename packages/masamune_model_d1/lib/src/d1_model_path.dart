...
class D1ModelPath {
  ...
  ///
  /// ドキュメントクエリーから作成します。
  factory D1ModelPath.fromDocumentQuery(ModelAdapterDocumentQuery query) {
    return D1ModelPath._parse(
      query.query.path,
      document: true,
    );
  }
  ...
  ///
  /// コレクションクエリーから作成します。
  factory D1ModelPath.fromCollectionQuery(ModelAdapterCollectionQuery query) {
    return D1ModelPath._parse(
      query.query.path,
      document: false,
    );
