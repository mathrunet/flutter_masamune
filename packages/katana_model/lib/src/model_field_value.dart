...
class ModelServerCommandBase extends ModelFieldValue<String>
  ...
  factory ModelServerCommandBase.fromJson(DynamicMap json) {
    return ModelServerCommandBase.fromServer(
      ...
      publicParameters: json.getAsMap(kPublicParametersKey, {}),
      privateParameters: json.getAsMap(kPrivateParametersKey, {}),
    );
  }
  ...
  DynamicMap toJson() => {
        ...
        kPublicParametersKey: publicParameters,
        kPrivateParametersKey: privateParameters,
        kSourceKey: _source.name,
      };
