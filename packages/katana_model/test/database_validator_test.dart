...
void main() {
  ...
  test("databaseValidator.clientUser", () async {
    String? userId = "ABCDEFG";
    var adapter = RuntimeModelAdapter(
      database: NoSqlDatabase(),
      validator: DatabaseValidator(onRetrieveUserId: () => userId),
    ...
    collectionQuery = CollectionModelQuery(
      ...
      adapter: adapter,
      validationQueries: const [
        AllowCreateModelValidationQuery.clientUser(),
      ],
    );
    collection = RuntimeCollectionModel(collectionQuery);
    userId = null;
    ...
    collectionQuery = CollectionModelQuery(
      ...
      validationQueries: const [
        AllowCreateModelValidationQuery.clientUser(),
        AllowReadCollectionModelValidationQuery.clientUser(),
      ],
    );
    collection = RuntimeCollectionModel(collectionQuery);
    userId = null;
    ...
    collectionQuery = CollectionModelQuery(
      ...
      validationQueries: const [
        AllowCreateModelValidationQuery.clientUser(),
        AllowUpdateModelValidationQuery.clientUser(),
        AllowReadCollectionModelValidationQuery.clientUser(),
      ],
    );
    collection = RuntimeCollectionModel(collectionQuery);
    ...
    documentQuery = DocumentModelQuery(
      ...
      validationQueries: const [
        ...
        AllowUpdateModelValidationQuery.clientUser(),
        AllowReadCollectionModelValidationQuery.clientUser(),
        AllowReadDocumentModelValidationQuery.clientUser(),
      ],
    );
    document = RuntimeMapDocumentModel(documentQuery);
    userId = null;
    ...
    collectionQuery = CollectionModelQuery(
      ...
      validationQueries: const [
        AllowCreateModelValidationQuery.clientUser(),
        AllowUpdateModelValidationQuery.clientUser(),
        AllowDeleteModelValidationQuery.clientUser(),
        AllowReadCollectionModelValidationQuery.clientUser(),
        AllowReadDocumentModelValidationQuery.clientUser(),
      ],
    );
    ...
    collectionQuery = CollectionModelQuery(
      ...
      adapter: adapter,
      validationQueries: const [
        AllowWriteModelValidationQuery.clientUser(),
      ],
    );
    collection = RuntimeCollectionModel(collectionQuery);
    document = collection.create();
    ...
    collectionQuery = CollectionModelQuery(
      ...
      validationQueries: const [
        AllowWriteModelValidationQuery.clientUser(),
        AllowReadModelValidationQuery.clientUser(),
      ],
    );
    collection = RuntimeCollectionModel(collectionQuery);
    userId = null;
