...
/// Display the menu to draw a 128px font [PainterTools].
///
/// 128pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size128pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 128px font [PainterTools].
  ///
  /// 128pxフォントを描画するメニューを表示する[PainterTools]。
  const Size128pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_128px__";
