...
/// Display the menu to draw a 56px font [PainterTools].
///
/// 56pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size56pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 56px font [PainterTools].
  ///
  /// 56pxフォントを描画するメニューを表示する[PainterTools]。
  const Size56pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_56px__";
