...
/// Display the menu to draw a 18px font [PainterTools].
///
/// 18pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size18pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 18px font [PainterTools].
  ///
  /// 18pxフォントを描画するメニューを表示する[PainterTools]。
  const Size18pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_18px__";
