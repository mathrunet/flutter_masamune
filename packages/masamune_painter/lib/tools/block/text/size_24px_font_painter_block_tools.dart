...
/// Display the menu to draw a 24px font [PainterTools].
///
/// 24pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size24pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 24px font [PainterTools].
  ///
  /// 24pxフォントを描画するメニューを表示する[PainterTools]。
  const Size24pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_24px__";
