...
/// Display the menu to draw a 96px font [PainterTools].
///
/// 96pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size96pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 96px font [PainterTools].
  ///
  /// 96pxフォントを描画するメニューを表示する[PainterTools]。
  const Size96pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_96px__";
