...
/// Display the menu to draw a 80px font [PainterTools].
///
/// 80pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size80pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 80px font [PainterTools].
  ///
  /// 80pxフォントを描画するメニューを表示する[PainterTools]。
  const Size80pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_80px__";
