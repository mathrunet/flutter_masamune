...
/// Display the menu to draw a 36px font [PainterTools].
///
/// 36pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size36pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 36px font [PainterTools].
  ///
  /// 36pxフォントを描画するメニューを表示する[PainterTools]。
  const Size36pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_36px__";
