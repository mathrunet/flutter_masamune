...
/// Display the menu to draw a 64px font [PainterTools].
///
/// 64pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size64pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 64px font [PainterTools].
  ///
  /// 64pxフォントを描画するメニューを表示する[PainterTools]。
  const Size64pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_64px__";
