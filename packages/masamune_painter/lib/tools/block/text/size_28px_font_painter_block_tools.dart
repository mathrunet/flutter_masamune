...
/// Display the menu to draw a 28px font [PainterTools].
///
/// 28pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size28pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 28px font [PainterTools].
  ///
  /// 28pxフォントを描画するメニューを表示する[PainterTools]。
  const Size28pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_28px__";
