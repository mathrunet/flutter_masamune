...
/// Display the menu to draw a 40px font [PainterTools].
///
/// 40pxフォントを描画するメニューを表示する[PainterTools]。
@immutable
class Size40pxFontPainterBlockTools extends PainterFontSizeBlockTools {
  /// Display the menu to draw a 40px font [PainterTools].
  ///
  /// 40pxフォントを描画するメニューを表示する[PainterTools]。
  const Size40pxFontPainterBlockTools({
  ...
  @override
  String get id => "__painter_block_text_size_40px__";
