...
extension MasamuneControllerAppRefExtensions on AppScopedValueOrAppRef {
...
extension MasamuneControllerPageScopedValueRefExtensions on PageScopedValueRef {
  ...
  TController controller<TController extends Listenable>(
    ...
    _ControllerQueryBase<TController, PageScopedValueRef> query,
  ) {
    return this.query(query);
  }
}
...
abstract class ControllerQueryBase<TController extends Listenable>
    extends _ControllerQueryBase<TController, AppScopedValueOrAppRef> {
  /// Base class for creating state-to-state usage queries for controllers that are code-generated by the builder.
  ///
  /// Basically, you can get a class that inherits from [ChangeNotifier].
  ///
...
abstract class _ControllerQueryBase<TController extends Listenable,
    TRef extends Ref> extends ChangeNotifierScopedQueryBase<TController, TRef> {
  const _ControllerQueryBase()
      : super(
          _provider,
        );
