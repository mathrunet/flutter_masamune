...
class FirebaseDynamicLinksUrlModel extends ValueModel<String?> {
  ...
  Future<void> _constructURI({
    ...
    try {
      ...
      //   uriPrefix: uriPrefix,
      //   link: Uri.parse(_path(uriPrefix)),
      //   androidParameters: AndroidParameters(
      //     packageName: packageName,
      //     minimumVersion: minimumVersion,
      //     fallbackUrl: androidFallbackLink != null
      //         ? Uri.tryParse(androidFallbackLink)
      //         : null,
      //   ),
      ...
      //     fallbackUrl:
      //         iosFallbackLink != null ? Uri.tryParse(iosFallbackLink) : null,
      //   ),
      //   socialMetaTagParameters: SocialMetaTagParameters(
      //     title: socialTitle?.localize(),
      //     description: socialDescription?.localize(),
      //     imageUrl: socialImageURL != null ? Uri.parse(socialImageURL) : null,
      //   ),
      // );
      // value = (await FirebaseDynamicLinks.instance.buildShortLink(data))
      //     .shortUrl
      //     .toString();
