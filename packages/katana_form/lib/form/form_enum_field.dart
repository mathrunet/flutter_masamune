...
class FormEnumField<TEnum extends Enum, TValue> extends StatefulWidget {
  ...
  final TValue Function(FormContext<TValue> form, TEnum? value)? onSaved;
...
class _EnumTextField<TEnum extends Enum> extends FormField<TEnum> {
  _EnumTextField({
    required this.picker,
    Key? key,
    ...
    InputCounterWidgetBuilder? buildCounter,
          ...
          onSaved: onSaved,
          builder: (field) {
            final _EnumTextFieldState<TEnum> state =
                field as _EnumTextFieldState<TEnum>;
  ...
  @override
  _EnumTextFieldState<TEnum> createState() => _EnumTextFieldState<TEnum>();
}

class _EnumTextFieldState<TEnum extends Enum> extends FormFieldState<TEnum> {
  TextEditingController? _controller;
  ...
  @override
  _EnumTextField<TEnum> get widget => super.widget as _EnumTextField<TEnum>;
  ...
  @override
  void didUpdateWidget(_EnumTextField<TEnum> oldWidget) {
