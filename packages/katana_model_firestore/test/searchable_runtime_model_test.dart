...
void main() {
  test("firestoreModelAdapter.searchableRuntimeDocumentModel.search", () async {
  ...
  test("firestoreModelAdapter.searchableRuntimeDocumentModel.search.Freezed",
      () async {
    final firestore = FakeFirebaseFirestore();
    final localDatabase = NoSqlDatabase();
    final adapter = FirestoreModelAdapter(
  ...
  test(
      "firestoreModelAdapter.searchableRuntimeRawCollectionModel.search.Freezed",
      () async {
