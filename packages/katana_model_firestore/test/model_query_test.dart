...
void main() {
  ...
  test("firestoreModelAdapter.ModelQuery.hasMatch", () async {
  ...
  test("firestoreModelAdapter.ModelQuery.ModelCounter", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
  ...
  test("firestoreModelAdapter.ModelQuery.ModelTimestamp", () async {
  ...
  test("firestoreModelAdapter.ModelQuery.ModelDate", () async {
    var query = ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
    ...
    expect(
      query.hasMatchAsMap(
          {"count": ModelDate(DateTime(2000, 1, 2)).toJson(), "text": "aaaa"}),
      false,
    );
    expect(
      query.hasMatchAsMap(
          {"count": ModelDate(DateTime(2000, 1, 3)).toJson(), "text": "aaaa"}),
      true,
    );
    expect(
      query.hasMatchAsMap(
          {"count": ModelDate(DateTime(2000, 1, 4)).toJson(), "text": "aaaa"}),
      true,
    );
    query = ModelQuery(
      "aaaa/bbbb",
  ...
  test("firestoreModelAdapter.ModelQuery.ModelUri", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelImageUri", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelVideoUri", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelSearch", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelGeoValue", () async {
  ...
  test("firestoreModelAdapter.ModelQuery.ModelLocalizedValue", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelLocale", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.ModelRef", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.equal(
  ...
  test("firestoreModelAdapter.ModelQuery.sort", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
  ...
  test("firestoreModelAdapter.ModelQuery.sort.ModelCounter", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.orderByAsc(key: "count"),
  ...
  test("firestoreModelAdapter.ModelQuery.sort.ModelTimestamp", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.orderByAsc(key: "count"),
  ...
  test("firestoreModelAdapter.ModelQuery.sort.ModelDate", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.orderByAsc(key: "count"),
    ...
    expect(
      query.sort(
        [
          MapEntry(
              "dddd", {"count": ModelDate(DateTime(2010, 1, 1)), "text": "a"}),
          MapEntry(
              "dddd", {"count": ModelDate(DateTime(2008, 1, 1)), "text": "a"}),
          MapEntry(
              "dddd", {"count": ModelDate(DateTime(2004, 1, 1)), "text": "a"}),
          MapEntry(
              "dddd", {"count": ModelDate(DateTime(2001, 1, 1)), "text": "a"}),
        ],
      ).toString(),
      [
        MapEntry(
    ...
    expect(
      query.sort(
        [
          MapEntry("dddd",
              {"count": ModelDate(DateTime(2010, 1, 1)).toJson(), "text": "a"}),
          MapEntry("dddd",
              {"count": ModelDate(DateTime(2004, 1, 1)).toJson(), "text": "a"}),
          MapEntry("dddd",
              {"count": ModelDate(DateTime(2008, 1, 1)).toJson(), "text": "a"}),
          MapEntry("dddd",
              {"count": ModelDate(DateTime(2001, 1, 1)).toJson(), "text": "a"}),
        ],
      ).toString(),
      [
        MapEntry("dddd",
  ...
  test("firestoreModelAdapter.ModelQuery.seekIndex", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
        ModelQueryFilter.orderByAsc(key: "count"),
  ...
  test("firestoreModelAdapter.ModelQuery.search", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
  ...
  test("firestoreModelAdapter.ModelQuery.Enum", () async {
    var query = const ModelQuery(
      "aaaa/bbbb",
      filters: [
  ...
  test("firestoreModelAdapter.ModelQuery.Enum.Freezed", () async {
    final firestore = FakeFirebaseFirestore();
    final localDatabase = NoSqlDatabase();
    final adapter = FirestoreModelAdapter(
      database: firestore,
