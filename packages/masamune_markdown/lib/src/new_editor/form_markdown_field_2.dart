...
class FormMarkdownField2<TValue> extends FormField<String> {
  /// Widget for Markdown text field for forms.
  ///
  /// You can use `h1`, `h2`, `h3`, and block styles for quotes and code.
  /// You can insert media such as images and videos.
  ...
  ///
  /// テキストフォーム用のコントローラー。
  final MarkdownController2? controller;
  ...
  @override
  FormFieldState<String> createState() => FormMarkdownFieldState2<TValue>();
}

/// State for FormMarkdownField.
///
/// フォーム用のMarkdownテキストフィールド用のステート。
class FormMarkdownFieldState2<TValue> extends FormFieldState<String>
    with AutomaticKeepAliveClientMixin<FormField<String>> {
  @override
  FormMarkdownField2<TValue> get widget =>
      super.widget as FormMarkdownField2<TValue>;
