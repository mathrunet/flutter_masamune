...
const _kHeadline3Type = "__markdown_block_headline_3__";
...
class MarkdownHeadline3BlockValue extends MarkdownMultiLineBlockValue {
  ...
  @override
  String get type => _kHeadline3Type;
  ...
  BlockStyle style(
    ...
    return BlockStyle(
      padding: controller.style.h3.padding ?? EdgeInsets.zero,
      margin: controller.style.h3.margin ?? EdgeInsets.zero,
      textStyle: (controller.style.h3.textStyle ??
              theme.textTheme.headlineSmall ??
              const TextStyle())
          .copyWith(
        color: controller.style.h3.foregroundColor,
      ),
      borderRadius: controller.style.h3.borderRadius,
      border: controller.style.h3.border,
      backgroundColor: controller.style.h3.backgroundColor,
    );
  }
