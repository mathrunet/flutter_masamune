...
class MarkdownHeadline1BlockValue extends MarkdownMultiLineBlockValue {
  ...
  BlockStyle style(
    ...
    return BlockStyle(
      padding: controller.style.h1.padding ?? EdgeInsets.zero,
      margin: controller.style.h1.margin ?? EdgeInsets.zero,
      textStyle: (controller.style.h1.textStyle ??
              theme.textTheme.headlineLarge ??
              const TextStyle())
          .copyWith(
        color: controller.style.h1.foregroundColor,
      ),
      borderRadius: controller.style.h1.borderRadius,
      border: controller.style.h1.border,
      backgroundColor: controller.style.h1.backgroundColor,
    );
  }
