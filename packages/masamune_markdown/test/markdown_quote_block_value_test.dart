...
void main() {
  testWidgets("MarkdownField.blockProperty.quote.insert", (tester) async {
    ...
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock1?.indent ?? 0));
    ...
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock2?.indent ?? 0));
  ...
  testWidgets("MarkdownField.blockProperty.quote.newLine", (tester) async {
    ...
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock7?.indent ?? 0));
    await input.enterText("bbb");
    expect(controller.selection.baseOffset, 7);
    expect(controller.plainText, "aaa\nbbb");
    expect(controller.rawText, "aaa\nbbb");
  ...
  testWidgets("MarkdownField.blockProperty.quote.cutCopyAndPaste",
    ...
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock8?.indent ?? 0));
    await input.enterText("bbb");
    final currentBlock9 = controller.getCurrentBlock();
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock9?.indent ?? 0));
    await input.enterText("ccc");
    expect(controller.selection.baseOffset, 11);
    expect(controller.plainText, "aaa\nbbb\nccc");
    expect(controller.rawText, "aaa\nbbb\nccc");
  ...
  testWidgets("MarkdownField.blockProperty.quote.undoRedo", (tester) async {
    ...
    controller.insertBlock(MarkdownQuoteBlockValue.createEmpty(indent: currentBlock10?.indent ?? 0));
    await input.enterText("bbb");
    expect(controller.selection.baseOffset, 7);
    expect(controller.plainText, "aaa\nbbb");
    expect(controller.rawText, "aaa\nbbb");
