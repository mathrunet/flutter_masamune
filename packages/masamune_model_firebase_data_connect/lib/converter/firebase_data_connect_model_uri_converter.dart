...
/// FirebaseDataConnectConverter for [ModelUri].
///
/// [ModelUri]用のFirebaseDataConnectConverter。
class FirebaseDataConnectModelUriConverter
    extends FirebaseDataConnectModelFieldValueConverter {
  /// FirebaseDataConnectConverter for [ModelUri].
  ///
  /// [ModelUri]用のFirebaseDataConnectConverter。
  const FirebaseDataConnectModelUriConverter();
  ...
  String _convertTo(DynamicMap map) {
    final val = map.get(ModelUri.kUriKey, "");
    return "$prefix$val";
  }
  ...
  Object? convertQueryValue(
    ...
    return "$prefix${(filter.value as ModelUri).value}";
  }
