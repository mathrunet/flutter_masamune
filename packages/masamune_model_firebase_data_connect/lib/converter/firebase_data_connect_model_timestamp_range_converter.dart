...
/// FirebaseDataConnectConverter for [ModelTimestampRange].
///
/// [ModelTimestampRange]用のFirebaseDataConnectConverter。
class FirebaseDataConnectModelTimestampRangeConverter
    extends FirebaseDataConnectModelFieldValueConverter {
  /// FirebaseDataConnectConverter for [ModelTimestamp].
  ///
  /// [ModelTimestampRange]用のFirebaseDataConnectConverter。
  const FirebaseDataConnectModelTimestampRangeConverter();
  ...
  String _convertTo(DynamicMap map) {
    final start = map.get<num>(ModelTimestampRange.kStartTimeKey, 0.0);
    final end = map.get<num>(ModelTimestampRange.kEndTimeKey, 0.0);
