...
/// FirebaseDataConnectConverter for [ModelImageUri].
///
/// [ModelImageUri]用のFirebaseDataConnectConverter。
class FirebaseDataConnectModelImageUriConverter
    extends FirebaseDataConnectModelFieldValueConverter {
  /// FirebaseDataConnectConverter for [ModelImageUri].
  ///
  /// [ModelImageUri]用のFirebaseDataConnectConverter。
  const FirebaseDataConnectModelImageUriConverter();
  ...
  String _convertTo(DynamicMap map) {
    final val = map.get(ModelImageUri.kUriKey, "");
    return "$prefix$val";
  }
  ...
  Object? convertQueryValue(
    ...
    return "$prefix${(filter.value as ModelImageUri).value}";
  }
