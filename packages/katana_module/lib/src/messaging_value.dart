...
/// Class for storing data for Messaging and PUSH notifications.
@immutable
class MessagingValue {
  /// Class for storing data for Messaging and PUSH notifications.
  ...
  /// Path of the page to navigate to.
  final String? path;

  /// Other data.
  final DynamicMap data;

  /// True if the application was opened at the right time.
  final bool onOpenedApp;
