...
/// Contents of text_requirements_analyzer.md.
///
/// text_requirements_analyzer.mdの中身。
class TextRequirementsAnalyzerClaudeCodeAgentsCliAiCode extends CliAiCode {
  /// Contents of text_requirements_analyzer.md.
  ///
  /// text_requirements_analyzer.mdの中身。
  ...
  @override
  String get name => "TextRequirementsAnalyzer";

  @override
  String get description => "テキストの要件を分析するエージェント。";
