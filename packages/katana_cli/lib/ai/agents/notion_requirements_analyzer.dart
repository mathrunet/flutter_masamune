...
/// Contents of notion_requirements_analyzer.md.
///
/// notion_requirements_analyzer.mdの中身。
class NotionRequirementsAnalyzerClaudeCodeAgentsCliAiCode extends CliAiCode {
  /// Contents of notion_requirements_analyzer.md.
  ///
  /// notion_requirements_analyzer.mdの中身。
  ...
  @override
  String get name => "NotionRequirementsAnalyzer";

  @override
  String get description => "Notionの要件を分析するエージェント。";
