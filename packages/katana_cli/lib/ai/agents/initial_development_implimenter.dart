...
/// Contents of initial_development_implimenter.md.
///
/// initial_development_implimenter.mdの中身。
class InitialDevelopmentImplimenterClaudeCodeAgentsCliAiCode extends CliAiCode {
  /// Contents of initial_development_implimenter.md.
  ///
  /// initial_development_implimenter.mdの中身。
  ...
  @override
  String get name => "初期開発実装エージェント";

  @override
  String get description => "設計書に基づいてコードを実装し、バリデーションとテストまで完了させます。";
