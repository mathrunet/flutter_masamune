...
/// Contents of design_implementation_guide.md.
///
/// design_implementation_guide.mdの中身。
class DesignImplementationGuideClaudeCodeAgentsCliAiCode extends CliAiCode {
  /// Contents of design_implementation_guide.md.
  ///
  /// design_implementation_guide.mdの中身。
  ...
  @override
  String get name => "デザイン実装ガイド";

  @override
  String get description => "デザイン実装ガイド。";
