...
/// Contents of page_test.md.
///
/// page_test.mdの中身。
class PageTestMdCliAiCode extends CliAiCode {
  /// Contents of page_test.md.
  ///
  /// page_test.mdの中身。
  const PageTestMdCliAiCode();

  @override
  String get name => "`Page`のテストの実装";
  ...
  @override
  String get description => "`Page`のテストの実装方法";
