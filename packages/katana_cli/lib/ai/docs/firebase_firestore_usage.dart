...
/// Contents of firebase_firestore_usage.md.
///
/// firebase_firestore_usage.mdの中身。
class FirebaseFirestoreUsageDocsMdCliAiCode extends CliAiCode {
  /// Contents of firebase_firestore_usage.md.
  ///
  /// firebase_firestore_usage.mdの中身。
  ...
  @override
  String get name => "`Firebase`や`Firestore`の実装方法とその利用方法";

  @override
  String get description => "サーバー側を管理する`Firestore`や`Firebase`の実装方法とその利用方法";
