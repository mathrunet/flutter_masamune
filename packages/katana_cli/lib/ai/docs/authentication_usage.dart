...
/// Contents of authentication_usage.md.
///
/// authentication_usage.mdの中身。
class AuthenticationUsageDocsMdCliAiCode extends CliAiCode {
  /// Contents of authentication_usage.md.
  ///
  /// authentication_usage.mdの中身。
  const AuthenticationUsageDocsMdCliAiCode();

  @override
  String get name => "`Authentication`の実装方法とその利用方法";

  @override
  String get description => "ユーザーの認証を行う`Authentication`の実装方法とその利用方法";
