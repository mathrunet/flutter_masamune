...
/// Contents of force_updater.md.
///
/// force_updater.mdの中身。
class PluginForceUpdaterMdCliAiCode extends PluginUsageCliAiCode {
  /// Contents of force_updater.md.
  ///
  /// force_updater.mdの中身。
  const PluginForceUpdaterMdCliAiCode();

  @override
  String get name => "強制アップデート";

  @override
  String get description => "`強制アップデート`の利用方法";
