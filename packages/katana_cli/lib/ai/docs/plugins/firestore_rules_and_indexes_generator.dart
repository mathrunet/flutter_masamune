...
/// Contents of firestore_rules_and_indexes_generator.md.
///
/// firestore_rules_and_indexes_generator.mdの中身。
class PluginFirestoreRulesAndIndexesGeneratorMdCliAiCode
    extends PluginUsageCliAiCode {
  /// Contents of firestore_rules_and_indexes_generator.md.
  ///
  /// firestore_rules_and_indexes_generator.mdの中身。
  const PluginFirestoreRulesAndIndexesGeneratorMdCliAiCode();

  @override
  String get name => "Firestoreルール・インデックス自動生成";

  @override
  String get description => "`Firestoreルール・インデックス自動生成`の利用方法";
