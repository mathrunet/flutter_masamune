...
///
/// scheduler.mdの中身。
class PluginSchedulerMdCliAiCode extends PluginUsageCliAiCode {
  /// Contents of scheduler.md.
  ///
  /// scheduler.mdの中身。
  const PluginSchedulerMdCliAiCode();

  @override
  String get name => "スケジューラー";

  @override
  String get description => "`スケジューラー`の利用方法";
