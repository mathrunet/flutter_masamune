...
/// Contents of app_check.md.
///
/// app_check.mdの中身。
class PluginAppCheckMdCliAiCode extends PluginUsageCliAiCode {
  /// Contents of app_check.md.
  ///
  /// app_check.mdの中身。
  const PluginAppCheckMdCliAiCode();

  @override
  String get name => "Firebase App Check";

  @override
  String get description => "`Firebase App Check`の利用方法";
