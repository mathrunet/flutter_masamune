...
/// Contents of model_video_uri.md.
///
/// model_video_uri.mdの中身。
class ModelFieldValueModelVideoUriMdCliAiCode extends ModelFieldValueCliAiCode {
  /// Contents of model_video_uri.md.
  ///
  /// model_video_uri.mdの中身。
  const ModelFieldValueModelVideoUriMdCliAiCode();
