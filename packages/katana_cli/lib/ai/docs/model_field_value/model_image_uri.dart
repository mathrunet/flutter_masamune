...
/// Contents of model_image_uri.md.
///
/// model_image_uri.mdの中身。
class ModelFieldValueModelImageUriMdCliAiCode extends ModelFieldValueCliAiCode {
  /// Contents of model_image_uri.md.
  ///
  /// model_image_uri.mdの中身。
  const ModelFieldValueModelImageUriMdCliAiCode();
