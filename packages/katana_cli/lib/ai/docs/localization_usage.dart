...
/// Contents of localization_usage.md.
///
/// localization_usage.mdの中身。
class LocalizationUsageMdCliAiCode extends CliAiCode {
  /// Contents of localization_usage.md.
  ///
  /// localization_usage.mdの中身。
  const LocalizationUsageMdCliAiCode();

  @override
  String get name => "ローカライゼーション（多言語対応）の実装と利用方法";

  @override
  String get description => "アプリ内の多言語対応を実装するためのガイドラインとその利用方法";
