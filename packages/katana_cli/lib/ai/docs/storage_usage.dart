...
/// Contents of storage_usage.md.
///
/// storage_usage.mdの中身。
class StorageUsageDocsMdCliAiCode extends CliAiCode {
  /// Contents of storage_usage.md.
  ///
  /// storage_usage.mdの中身。
  const StorageUsageDocsMdCliAiCode();

  @override
  String get name => "`Storage`の実装方法とその利用方法";

  @override
  String get description => "ファイルの保存や取得を行う`Storage`の実装方法とその利用方法";
