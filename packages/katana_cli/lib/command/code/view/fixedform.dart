...
///
/// 固定フォームページのテンプレートを作成します。
class CodeViewFixedFormCliCommand extends CliTestableCodeCommand {
  /// Create a template for the fixed form page.
  ///
  /// 固定フォームページのテンプレートを作成します。
  const CodeViewFixedFormCliCommand();

  @override
  String get name => "template_fixedform";

  @override
  String get prefix => "templateFixedForm";
  ...
  String get description =>
      "Create a template for the fixed form page in `$directory/(filepath).dart`. 固定フォームページのテンプレートを`$directory/(filepath).dart`に作成します。";

  @override
  String? get example => "katana code tmp fixedform [page_name]";
