...
/// Code base for creating Boot pages.
///
/// Bootページを作成するためのコードベース。
class BootCliCode extends CliCode {
  /// Code base for creating Boot pages.
  ///
  /// Bootページを作成するためのコードベース。
  const BootCliCode();
  ...
  String get description =>
      "Create a class to describe the boot page. The class name is [Boot]. ブートページを記述するためのクラスを作成します。クラス名は[Boot]となります。";
