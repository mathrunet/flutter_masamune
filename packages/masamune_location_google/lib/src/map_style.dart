...
/// {@template map_style}
/// Class that defines the style of the map.
///
/// マップのスタイルを定義するクラス。
/// {@endtemplate}
class MapStyle {
  ...
  /// マップのスタイルを定義するクラス。
  /// {@endtemplate}
  const MapStyle(String style) : _style = style;

  /// Normal Google Maps.
  ///
  /// The label can be hidden by specifying [hiddenLable].
  ///
  /// 通常のGoogleマップ。
  ///
  /// [hiddenLable]を指定することでラベルを非表示にすることができます。
  ///
  /// {@macro map_style}
